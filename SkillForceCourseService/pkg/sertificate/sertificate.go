...
func GenerateGoodCertificate(name, course, dateStr string, outputFile string) error {
	...
	pdf.SetXY(0, 95)
	pdf.CellFormat(0, 20, "с отличием завершил(а) курс", "", 0, "C", false, 0, "")
...
func GenerateNormalCertificate(name, course, dateStr string, outputFile string) error {
	pdf := gofpdf.New("L", "mm", "A4", "")
	pdf.AddPage()
	...
	pdf.SetXY(0, 95)
	pdf.CellFormat(0, 20, "завершил(а) курс", "", 0, "C", false, 0, "")
