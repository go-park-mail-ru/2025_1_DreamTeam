...
func main() {
	...
	siteMux.HandleFunc("/api/sendSurveyQuestionAnswer", courseHandler.SendSurveyQuestionAnswer)
	siteMux.HandleFunc("/api/getSurveyMetrics", courseHandler.GetSurveyMetrics)
