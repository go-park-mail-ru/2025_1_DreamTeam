...
// Source: internal/delivery/http/handlers/course/course_handlers.go
...
func (m *MockCourseUsecaseInterface) CreateCourse(ctx context.Context, course *dto.CourseDTO, userProfile *usermodels.UserProfile) error {
	m.ctrl.T.Helper()
...
func (mr *MockCourseUsecaseInterfaceMockRecorder) CreateCourse(ctx, course, userProfile interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateCourse", reflect.TypeOf((*MockCourseUsecaseInterface)(nil).CreateCourse), ctx, course, userProfile)
}
...
func (m *MockCourseUsecaseInterface) GetCourse(ctx context.Context, courseId int, userProfile *usermodels.UserProfile) (*dto.CourseDTO, error) {
	m.ctrl.T.Helper()
